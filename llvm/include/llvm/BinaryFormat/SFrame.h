...
static_assert(std::is_trivial<sframe_preamble> == true);
...
static_assert(std::is_trival<sframe_frame_row_entry_addr1> == true);
static assert(sizeof(sframe_frame_row_entry_addr1) == 2);
...
static_assert(std::is_trival<sframe_frame_row_entry_addr2> == true);
static assert(sizeof(sframe_frame_row_entry_addr1) == 3);
